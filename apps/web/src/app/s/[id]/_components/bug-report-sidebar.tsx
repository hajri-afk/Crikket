          ...
          <div className="space-y-6 p-4">
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-3 text-sm">
                ...
                {/* QA scope: which feature was exercised and how. */}
                <DetailRow
                  label="Feature / menu tested"
                  value={data.testedFeature}
                />
                <div className="pt-2">
                  <div className="mb-1 flex flex-wrap items-center justify-between gap-2">
                    ...
                    {data.testCaseType ? (
                      <TestCaseTypeBadge value={data.testCaseType} />
                    ) : null}
                  </div>
                  <p className="min-h-[60px] whitespace-pre-wrap rounded-md border bg-muted/30 p-2 text-foreground text-sm leading-relaxed">
                    {data.testScenario ||
                      "No test scenario recorded by QA for this report."}
                  </p>
                </div>
              </div>
            </div>
