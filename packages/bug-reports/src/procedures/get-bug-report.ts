...
import { DEFAULT_ROOM_COLOR, isRoomColor } from "@crikket/shared/constants/room"
import { isTestCaseType } from "@crikket/shared/constants/test-case"
    ...
    return {
      ...
      room: report.room
        ? {
            ...
            slug: report.room.slug,
            color: isRoomColor(report.room.color)
              ? report.room.color
              : DEFAULT_ROOM_COLOR,
          }
        : null,
